<header class="navbar navbar header-outer" role="banner">
    <div class="container form-inline">
        <a class="logo"><img src="<?php echo $view['assets']->getUrl('images/work_on_opt_logo.jpg') ?>" width="280"></a>
        ...
        <ul class="nav navbar-nav">
            ...
            <li>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo $view['router']->generate('jobs_web_jobseeker_myresumes'); ?>">Manage Resume</a></li>
            ...
            <li><div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo $view['router']->generate('jobs_web_employer_myjobs'); ?>">Manage Jobs</a></li>
